 ...
 * @author cataclysm
 */
public class P500Handler implements EventHandler<ActionEvent>{
    BettingGame game;
    MyVBox vbox;
    QuestionClass q;
    public P500Handler(BettingGame game,MyVBox vbox,QuestionClass q){
        this.game=game;
        this.vbox=vbox;
        this.q=q;
    }
    ...
    public void handle(ActionEvent e){
        ...
        //create the button for the player to see his points

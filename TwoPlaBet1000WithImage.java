 ...
 * @author cataclysm
 */
public class TwoPlaBet1000WithImage implements EventHandler<ActionEvent>{
    TwoPlaBettingGame game;
    MyVBox vbox;
    QuestionClassWithImage q;
    int x;
    boolean allow=true;
    public TwoPlaBet1000WithImage(TwoPlaBettingGame game,MyVBox vbox,QuestionClassWithImage q,int x){
        this.game=game;
        this.vbox=vbox;
        this.q=q;
        this.x=x;

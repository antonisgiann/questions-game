 ...
 * @author cataclysm
 */
public class TwoPlaBet500Handler implements EventHandler<ActionEvent>{
    TwoPlaBettingGame game;
    MyVBox vbox;
    QuestionClass q;
    int x;
    boolean allow=true;
    public TwoPlaBet500Handler(TwoPlaBettingGame game,MyVBox vbox,QuestionClass q,int x){
        this.game=game;
        this.vbox=vbox;
        this.q=q;
        this.x=x;

 ...
 * @author cataclysm
 */
public class TwoPlaCorrectAnswerWithImage implements EventHandler<ActionEvent>{
    TwoPlaCorrectAnswerGame game; 
    MyVBox vbox;
    Player player;
    boolean allow=true;
     public TwoPlaCorrectAnswerWithImage(TwoPlaCorrectAnswerGame game,MyVBox vbox,Player player){
         this.game=game;
         this.vbox=vbox;
         this.player=player;
     }

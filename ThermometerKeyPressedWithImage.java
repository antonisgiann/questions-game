 ...
 * @author cataclysm
 */
public class ThermometerKeyPressedWithImage implements EventHandler<KeyEvent>{
    ...
    private final QuestionClassWithImage q1;
    private final QuestionClassWithImage q2;
    public ThermometerKeyPressedWithImage(ThermometerGame game1,ThermometerGame game2,MyVBox vbox,ArrayList<Button> answers,QuestionClassWithImage q1,QuestionClassWithImage q2){
        this.game1=game1;
        this.game2=game2;
        this.vbox=vbox;
...
//reset the questions and start the next round
                                  try{
                                      game1.getAllTheQuestionsWithImage();
                                      game2.getAllTheQuestionsWithImage();
                                  }
                                   catch(FileNotFoundException exc){
                                      System.out.println(exc.toString());
                                  }
                                  ThermometerGame.showQuestionsFirstTimeWithImage(game1, game2, vbox, ThermometerGame.getBp(), answers);
                             }
                         }
                         else
                         {
//display a new question for player 1
                             ThermometerGame.questionWithImageForPlayer1(game1, game2, vbox, answers, q2);
                         }
                     }
...
//display a question for the player 2
                             ThermometerGame.questionWithImageForPlayer2(game1, game2, vbox, answers, q1);
                         }
                     }

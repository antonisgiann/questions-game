 ...
 * @author cataclysm
 */
public class TwoPlaBetCorrectAnswerWithImage implements EventHandler<ActionEvent>{
    TwoPlaBettingGame game;
    MyVBox vbox;
    boolean allow=true;
    int x;
    public TwoPlaBetCorrectAnswerWithImage(TwoPlaBettingGame game,MyVBox vbox,int x){
        this.game=game;
        this.vbox=vbox;
        this.x=x;
    }
...
//check who of the players is using this handler and add the points to him
            if(x==1)
                ...
                game.getPlayer2().addPoints(game.getPointsPerAnswer2());
            game.incControl();

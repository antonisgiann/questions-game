 ...
 * @author cataclysm
 */
public class BetWrongAnswer implements EventHandler<ActionEvent>{
    BettingGame game;
    MyVBox vbox;
    public BetWrongAnswer(BettingGame game,MyVBox vbox){
        this.game=game;
        this.vbox=vbox;
    }
    @Override
    public void handle(ActionEvent e){
        MyVBox.clear(vbox);
        //remove points from the player for answering wrong the question

 ...
 * @author cataclysm
 */
public class TwoPlaBetWrongAnswerWithImage implements EventHandler<ActionEvent>{
    TwoPlaBettingGame game;
    MyVBox vbox;
    boolean allow=true;
    int x;
    public TwoPlaBetWrongAnswerWithImage(TwoPlaBettingGame game,MyVBox vbox,int x){
        this.game=game;
        this.vbox=vbox;
        this.x=x;
    }

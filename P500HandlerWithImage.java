 ...
 * @author cataclysm
 */
public class P500HandlerWithImage implements EventHandler<ActionEvent>{
    BettingGame game;
    MyVBox vbox;
    QuestionClassWithImage q;
    public P500HandlerWithImage(BettingGame game,MyVBox vbox,QuestionClassWithImage q){
        this.game=game;
        this.vbox=vbox;
        this.q=q;
    }

 ...
 * @author cataclysm
 */
public class TwoPlaBet1000Handler implements EventHandler<ActionEvent>{
    TwoPlaBettingGame game;
    MyVBox vbox;
    QuestionClass q;
    int x;
    boolean allow=true;
    public TwoPlaBet1000Handler(TwoPlaBettingGame game,MyVBox vbox,QuestionClass q,int x){
        this.game=game;
        this.vbox=vbox;
        this.q=q;
        this.x=x;

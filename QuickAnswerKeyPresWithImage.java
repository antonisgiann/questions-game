...
public class QuickAnswerKeyPresWithImage implements EventHandler<KeyEvent>{
    private final QuickAnswerGame game;
    private final MyVBox vbox;
    private final QuestionClassWithImage q;
    private final Player player1;
    private final Player player2;
    private final ArrayList<Button> answers;
    private boolean first=true;
    public QuickAnswerKeyPresWithImage(QuickAnswerGame game,MyVBox vbox,QuestionClassWithImage q,Player player1,Player player2,ArrayList<Button> answers){
        this.game=game;
        this.vbox=vbox;
        this.q=q;
...
//save the statistics of the game to the output file
                           ...
                           else
                           {
                               ...
                               player2.setPoints(0);
                               MyVBox.clear(vbox);
                               QuickAnswerGame.questionWithImageForPlayers(game, player1, player2, vbox, answers);
                           }
                        }
                        else
                        {
